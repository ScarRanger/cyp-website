...
function CategorySelect({ categories, active, onChange }: { categories: CategoryTab[]; active: string; onChange: (c: string) => void; }) {
  return (
    <div className="container mx-auto px-4 py-6">
      ...
      <select
        ...
        className="w-full max-w-xs rounded-lg border border-gray-300 bg-white px-3 py-2 text-sm text-gray-900 focus:outline-none focus:ring-2 focus:ring-gray-900"
      >
...
export default function GalleryPage() {
  ...
  return (
    <div>
      <Hero />
      <CategorySelect categories={cats} active={category} onChange={setCategory} />
